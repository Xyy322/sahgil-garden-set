...
export function NotFound() {
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center bg-[#f9f7f4] px-4 text-center">
      ...
      <h2 className="text-3xl font-bold text-stone-800 mb-6">Page Not Found</h2>
      <p className="text-lg text-stone-600 max-w-md mx-auto mb-10">
        It looks like you've wandered off the garden path. The page you're looking for doesn't exist or has been moved.
      </p>
      <a 
        href="/" 
        className="px-8 py-4 bg-emerald-600 text-white rounded-full font-bold hover:bg-emerald-700 transition-all shadow-md shadow-emerald-600/20"
      >
        Return to Home
      </a>
    </div>
